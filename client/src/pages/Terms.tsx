        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              ...
              <p>
                7. 紹介コードを適用してお申し込みいただいた場合に限り、キャンペーン価格が適用されます。この場合、キャンペーン価格は所定の回数（3回）分のお支払いまでで、4回目のお支払いから通常価格へ切り替わり、以降は毎月同額で自動更新されます。切り替えの前にメールでお知らせします。紹介コードをご利用でない通常のご契約では、この取り扱いは適用されず、料金が途中で変わることはありません。
              </p>
            </div>
          </section>
