  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Qa q="Meta AI呼びかけ投稿とは？返事が付かないときは？">
        <p>1日の投稿のうち1件として、「@meta.ai 新倉敷・玉島で肩こりに悩む人に、整体に通うメリットを伝えて」のような投稿を1日1件、朝〜昼に自動で出します。Meta AIがお店の名前を出してコメントで答えるので、投稿の下に会話ができ、届く人が増えます。止めたいときは「設定」からOFFにできます。この機能はプロプラン・ビジネスプランでご利用いただけます。ライトプランの方は、プランを変更するとその日からお使いいただけます。</p>
        <p>@meta.ai はThreadsの仕様で段階的に提供されており、まだ使えないアカウントもあります。その場合はMeta AIの返事が付きません（投稿自体は出ます）。使えるようになった時点で、そのまま効き始めます。</p>
      </Qa>
