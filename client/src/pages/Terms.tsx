        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              ...
              <p>
                5. ユーザーが登録時または登録後に提供する氏名・店舗名（屋号）・メールアドレス等の情報は、本サービスの提供・本人確認のほか、
                <span className="text-foreground font-medium">当社が主催・提供するセミナーや関連サービスに関する情報配信（ご案内メールの送付等）</span>
                のために利用することがあります。これらのご案内が不要な場合は、案内メール内の手続きまたはお問い合わせ窓口からいつでも配信を停止できます。情報の取り扱いの詳細はプライバシーポリシーに従います。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                連携を解除すると、本サービスはThreadsアカウントへのアクセスを停止し、保存しているアクセストークンを削除します。
                投稿履歴などの関連データは、アカウントの削除またはデータ削除のご請求により削除されます。
              </p>
              <p>
          ...
          <section>
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              ...
              <p>
                3. 支払いはUnivapay（株式会社ユニヴァ・ペイキャスト）の決済システムを通じて処理されます。
                クレジットカード情報は当社サーバーを経由せず、Univapayが安全に処理・保管します。
              </p>
              <p>
                4. 有料プランには7日間の無料トライアルがあります。お申し込み時にカードをご登録いただき、トライアル期間（7日間）の終了後に初回のお支払いが発生し、以降は毎月自動更新されます。
              </p>
              <p>
                5. 解約はダッシュボードからいつでも可能です。無料トライアル期間中に解約された場合、料金は一切発生しません。
              </p>
              <p>
                6. 解約後も、支払い済み期間の終了まではサービスをご利用いただけます。
              </p>
              <p>
                7. 紹介コードを適用してお申し込みいただいた場合に限り、キャンペーン価格が適用されます。この場合、前項4号の7日間の無料トライアルは適用されず、お申し込み時に初回のお支払いが発生します。この場合、キャンペーン価格は所定の回数（3回）分のお支払いまでで、4回目のお支払いから通常価格へ切り替わり、以降は毎月同額で自動更新されます。切り替えの前にメールでお知らせします。紹介コードをご利用でない通常のご契約では、この取り扱いは適用されず、料金が途中で変わることはありません。
              </p>
            </div>
          </section>
