...
/** お尋ねの文（LINE） */
// ★「変わらないこと」を先に書く（既存のお客様へのお知らせの決まり・feedback_announce_changes_to_existing_users）
export const REVIEW_HOUR_QUESTION =
  "お選びにならなくても、これまでどおり毎朝6時ごろに案をお届けします（何も変わりません）。\n\n" +
  "もしご都合のよい時間があれば教えてください。投稿の案は、何時ごろにお届けすると確認しやすいですか？\n" +
  "選んでいただいた時間に合わせてお届けし、ご確認の前に公開時間が来ないようにします。\n" +
  "・昼までの時間 … その日の朝にお届けし、公開はご確認のあとにします\n" +
  "・夕方・夜 … 前の日のその時間に、翌日の案をお届けします\n" +
  "あとから変えるときは、メニューの「設定」→「案を見る時間を選ぶ」からいつでも選び直せます。";
