...
export default function Guide() {
  ...
  const postModes = [
    ...
    },
    {
      ...
      body: '毎日の投稿とは別に「@meta.ai 新倉敷・玉島で肩こりに悩む人に、整体に通うメリットを伝えて」のような投稿を朝〜昼に1件。Meta AIが店名を出してコメントで答え、会話が付いて届く人が増える。依頼文は登録内容から決まった型で作る。※@meta.aiはThreads側で段階提供のため、まだ使えないアカウントもある。',
      when: '設定ONなら自動（既定ON）',
    },
    {
      title: '量産（変奏）',
