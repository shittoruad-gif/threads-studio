    ...
    <div className="px-4 py-3">
      <div className="flex gap-3">
        ...
        <div className="flex flex-col items-center flex-shrink-0">
          ...
          {showThread && (
            <div className="w-0.5 flex-1 mt-2 mb-1 bg-muted-foreground/40 rounded-full min-h-[16px]" />
          )}
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mb-0.5">
            ...
            <button className="p-1 text-muted-foreground/60">
              <MoreHorizontal className="w-4 h-4" />
            </button>
          </div>

          {/* Post body */}
          <div className="text-[15px] leading-[1.4] text-foreground whitespace-pre-wrap break-words">
          ...
          {showActions && (
            <div className="flex items-center gap-4 mt-3">
              <Heart className="w-[19px] h-[19px] text-muted-foreground" strokeWidth={1.5} />
              <MessageCircle className="w-[19px] h-[19px] text-muted-foreground" strokeWidth={1.5} />
              <Repeat2 className="w-[19px] h-[19px] text-muted-foreground" strokeWidth={1.5} />
              <Send className="w-[18px] h-[18px] text-muted-foreground" strokeWidth={1.5} />
            </div>
          )}
        </div>
      </div>
          ...
          <div className="pt-[28px]">
            ...
            {hasThread && (
              <div className="px-4 py-2 border-b border-border/50 flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-foreground">スレッド</span>
                <span className="text-xs text-muted-foreground">{allPosts.length}件の投稿</span>
              </div>
            )}
