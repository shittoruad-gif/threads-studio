    ...
    <div className="px-4 py-3">
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Post body */}
          <div className="text-[15px] leading-[1.4] text-gray-900 whitespace-pre-wrap break-words">
          ...
          {showActions && (
            <div className="flex items-center gap-4 mt-3">
              <Heart className="w-[19px] h-[19px] text-gray-600" strokeWidth={1.5} />
              <MessageCircle className="w-[19px] h-[19px] text-gray-600" strokeWidth={1.5} />
              <Repeat2 className="w-[19px] h-[19px] text-gray-600" strokeWidth={1.5} />
              <Send className="w-[18px] h-[18px] text-gray-600" strokeWidth={1.5} />
            </div>
          )}
        </div>
      </div>
          ...
          <div className="pt-[28px]">
            ...
            {hasThread && (
              <div className="px-4 py-2 border-b border-gray-100 flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-gray-900">スレッド</span>
                <span className="text-xs text-gray-500">{allPosts.length}件の投稿</span>
              </div>
            )}
