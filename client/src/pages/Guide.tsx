...
export default function Guide() {
  ...
  const postModes = [
    ...
    },
    {
      ...
      body: '毎朝10時、公式LINEに「@meta.ai 新倉敷・玉島で整体院のおすすめを教えて」のような呼びかけ文が届く。「Threadsアプリで投稿する」を押すと文章入りの投稿画面が開くので「投稿」を押すだけ（自動投稿からだと@meta.aiがメンションにならないため、この1件だけアプリから）。Meta AIが店名を出してコメントで答え、届く人が増える。得意分野を登録すると「ダイエットに強い整体院」のように変わる。プロ／ビジネスプランで利用可。※@meta.aiはThreads側で段階提供のため、まだ使えないアカウントもある。',
