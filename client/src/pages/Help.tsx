  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Qa q="Meta AI呼びかけ投稿とは？返事が付かないときは？">
        <p>毎朝10時に、公式LINEへ「@meta.ai 新倉敷・玉島で整体院のおすすめを教えて」のような呼びかけ文が届きます。「Threadsアプリで投稿する」を押すと文章が入った投稿画面が開くので、投稿したいアカウントでログインしていることを確認して「投稿」を押すだけです。Meta AIがお店の名前を出してコメントで答えるので、投稿の下に会話ができ、届く人が増えます。</p>
