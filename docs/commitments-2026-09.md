...
| 岩根様（25） | 9/12〜14 4件、9/15 から3件 | extraPostsUntil=9/14 | 9/12 8件（9/11 の未確認4件＋9/12 の5件＝9件のカードを、ご本人が 9/12 18:13〜18:52 に手直し6件・見送り2件・承認8件。追い投稿ゼロ。8件ともご本人の操作で公開）／9/13 4件 ✅（お手本を入れ直して当日補充） |
...
| 髙木様（16 ダイエット）9/13 送付 | @miraiseitai.diet は 9/20 まで1日1件。減った分と消えた3件は **9/21 以降に1日1件ずつ足す**。@miraiseitai_kanazawa は1日3件のまま | cooldownUntil=9/20（公開時に1件で頭打ち）。**消えた3件を補填に積む仕組みは未実装 → 9/13 夜間整備で入れる（night-todo ★最優先）** | 9/14〜20 diet 1件・金沢 3件／9/21 から diet 4件 |
| 岩根様（25）9/13 送付 | 前日分を翌日に持ち越さない。1日の本数は契約を超えない（9/14 まで4件、9/15 から3件）。「見送る」を押さない限り予定時刻に公開 | 9/13 01:52 反映の promoteSoftApprovedDuePosts（前日分は見送り）。**全アカウントの1日上限は未実装 → 9/13 夜間整備** | 9/14 4件・9/15 3件。承認待ちが翌日に残っていないか |
