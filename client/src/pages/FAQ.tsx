  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Threadsでは2026年9月から、投稿で「@meta.ai」と呼びかけるとMeta AIがコメントで答えるようになりました。Threads Studioは毎朝10時に、公式LINEへ「@meta.ai 新倉敷・玉島の名産品と言えば？」「@meta.ai 初めて整体院に行くとき、知っておくと安心なことは？」のような呼びかけ文をお届けします。「Threadsアプリで投稿する」を押すと文章が入った投稿画面が開くので、「投稿」を押すだけです（自動投稿からだと@meta.aiがメンションにならないため、この1件だけアプリから投稿していただきます）。Meta AIがコメントで答えるので、投稿の下に会話ができ、地元の方の目に留まりやすくなります。質問は地元の話題・来店前に気になること・体の悩みなどで、毎日変わります。Meta AIの答えは間違うことがあるので、していないサービスや言い過ぎの表現が書かれていたら、その返信は「…」から非表示にできます。呼びかけ文は、はじめの設定で登録した地域・店名・業種から決まった型で作り、AIには書かせません。同じお店でメニュー別にアカウントがある場合は「設定」→「呼びかけの得意分野」でお店を紹介する日の文を「ダイエットに強い整体院」のように変えられます。止めたいときは「設定」からOFFにできます。この機能はプロプラン・ビジネスプランでご利用いただけます。ライトプランの方は、プランを変更するとその日からお使いいただけます。",
      },
      {
        question: "Meta AIの返事が付きません",
        answer:
          "考えられる理由は2つです。①自動投稿（API）から出した投稿は、Threadsの仕様で@meta.aiがメンションにならず返事が付きません。毎朝10時のLINEの「Threadsアプリで投稿する」ボタンから、アプリで投稿してください（投稿画面で@meta.aiが青いメンションになっていれば正しい状態です）。②@meta.ai はThreadsの仕様で段階的に提供されており、まだ使えないアカウントもあります。使えるようになった時点で、そのまま効き始めます。",
      },
      {
