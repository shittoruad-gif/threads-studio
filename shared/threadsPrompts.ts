...
- 絵文字を適度に使い、堅すぎない柔らかい印象にする。ただし1投稿に絵文字3〜4個までが自然。連発は避ける。
...
■ 整体院・接骨院・整骨院（伸びる型）
- 1行目フック例：「肩こりに湿布貼ってる人、効果ないので今すぐやめて」「腰が痛い時に温めるのは7割の人で間違い」「整体に毎週通ってるのに改善しない理由、教えます」
- 構成：強い言い切り → 理由（姿勢・筋膜・自律神経などの一言解説） → 「うちでやってるのは〜」と自然に強み → 「迷う人はLINEから症状送って」
- 伸びる絵文字：📍🦴🧘‍♀️💪
...
■ 美容サロン・エステ（伸びる型）
- 1行目フック例：「シミに高い化粧品買うのはお金の無駄」「肌荒れの本当の原因、化粧品じゃなくて〇〇です」「30代から急に老けた気がする人へ」
- 構成：「実は〇〇」で常識を覆す → 肌の仕組み（ターンオーバー・バリア機能・水分量）の小ネタ → 「こんな悩みの方は固定投稿でケア順を見て」
- 「個人差があります」を自然に織り込む

■ ピラティス・ヨガ・フィットネス（伸びる型）
- 1行目フック例：「腹筋しても痩せない人の共通点」「猫背を治す唯一の方法を10年指導してきて見つけました」「40代から運動するなら、これだけはやめて」
- 構成：「実は〇〇」or「やめて」で掴む → 体の仕組みの一言解説（インナーマッスル・骨盤・呼吸） → 「うちのレッスンでは〇〇を意識してます」
- 「痩せる」断定はNG。「目指せる」「サポート」「変化を感じやすい」に置換

■ 飲食店・カフェ（伸びる型）
- 1行目フック例：「〇〇市で隠れ家カフェ探してる人へ」「ランチに毎日行きたくなるお店、見つけました」「平日13時すぎに行くと〇〇が食べられます」
