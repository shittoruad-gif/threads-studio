          ...
          <table className="w-full border-collapse">
            <tbody className="divide-y divide-border">
              ...
              <tr>
                ...
                <td className="py-4 px-4 text-muted-foreground">
                  <strong className="text-foreground">【通常のご契約の場合】</strong><br />
                  有料プランには7日間の無料トライアルがあります。お申し込み時にカードをご登録いただき、
                  トライアル期間（7日間）の終了後に初回決済が行われ、以降は毎月同額で自動更新されます。
                  料金が途中で変わることはありません。
                  <br /><br />
                  <strong className="text-foreground">【紹介コードを適用された場合のみ】</strong><br />
                  紹介コードを入力してお申し込みいただいた方に限り、通常価格より割安なキャンペーン価格が適用されます。
                  <strong className="text-foreground">この場合、7日間の無料トライアルは適用されず、お申し込み時に初回のお支払いが発生します。</strong>
                  キャンペーン価格が適用されるのは所定の回数（3回）分のお支払いまでで、4回目のお支払いから通常価格へ切り替わり、
                  以降は毎月同額で自動更新されます。切り替えの前にメールでお知らせします。
                  切り替えを望まれない場合は、それまでに解約してください。
                  なお、紹介コードをご利用でない場合、この取り扱いは適用されません。
                </td>
              </tr>
              <tr>
