...
export default function Help() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <Qa q="Meta AI呼びかけ投稿とは？返事が付かないときは？">
        <p>毎朝10時に、公式LINEへ「@meta.ai 新倉敷・玉島の名産品と言えば？」「@meta.ai 初めて整体院に行くとき、知っておくと安心なことは？」のような呼びかけ文が届きます。「Threadsアプリで投稿する」を押すと文章が入った投稿画面が開くので、投稿したいアカウントでログインしていることを確認して「投稿」を押すだけです。Meta AIがコメントで答えるので、投稿の下に会話ができ、地元の方の目に留まりやすくなります。</p>
        <p>自動投稿（API）から出した投稿では@meta.aiがメンションにならず返事が付かないため、この1件だけはアプリから投稿していただく形です。同じお店でメニュー別にアカウントがある場合は、公式LINEの「設定」→「呼びかけの得意分野」で「ダイエットに強い整体院」のようにアカウントごとに変えられます。止めたいときは「設定」からOFFにできます。この機能はプロプラン・ビジネスプランでご利用いただけます。ライトプランの方は、プランを変更するとその日からお使いいただけます。</p>
        <p>@meta.ai はThreadsの仕様で段階的に提供されており、まだ使えないアカウントもあります。その場合はMeta AIの返事が付きません。使えるようになった時点で、そのまま効き始めます。</p>
      </Qa>
