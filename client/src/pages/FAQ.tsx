  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Threadsでは2026年9月から、投稿で「@meta.ai」と呼びかけるとMeta AIがコメントで答えるようになりました。Threads Studioは毎朝10時に、公式LINEへ「@meta.ai 新倉敷・玉島で整体院のおすすめを教えて」のような呼びかけ文をお届けします。「Threadsアプリで投稿する」を押すと文章が入った投稿画面が開くので、「投稿」を押すだけです（自動投稿からだと@meta.aiがメンションにならないため、この1件だけアプリから投稿していただきます）。Meta AIがお店の名前を出して答えるので、投稿の下に会話ができ、届く人が増えます。呼びかけ文は、はじめの設定で登録した地域・店名・業種から決まった型で作り、AIには書かせません。同じお店でメニュー別にアカウントがある場合は「設定」→「呼びかけの得意分野」で「ダイエットに強い整体院」のように変えられます。止めたいときは「設定」からOFFにできます。この機能はプロプラン・ビジネスプランでご利用いただけます。ライトプランの方は、プランを変更するとその日からお使いいただけます。",
      },
      {
