  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Threadsでは2026年9月から、コメント欄で「@meta.ai」と呼びかけるとMeta AIがコメントで答えるようになりました。Threads Studioは1日の投稿のうち1件として、「@meta.ai 新倉敷・玉島で肩こりに悩む人に、整体に通うメリットを伝えて」のような投稿を1日1件、朝〜昼に自動で出します。Meta AIがお店の名前を出して答えるので、投稿の下に会話ができ、届く人が増えます。依頼文は、はじめの設定で登録した地域・お客様像・店名から決まった型で作り、AIには書かせません。止めたいときは「設定」からOFFにできます。この機能はプロプラン・ビジネスプランでご利用いただけます。ライトプランの方は、プランを変更するとその日からお使いいただけます。",
      },
      {
